...
@Injectable()
export class MongoRefreshTokenRepository extends BaseMongoRepository<RefreshTokenEntity, RefreshTokenCreateDto, RefreshTokenUpdateDto, RefreshTokenDocument> implements IRefreshTokenRepository {
    constructor(@InjectModel(RefreshToken.name) protected readonly model: Model<RefreshTokenDocument>) {
        super(model);
    }
